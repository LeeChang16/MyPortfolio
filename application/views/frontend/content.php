	          ...
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
			            ...
			            <h1 class="mb-4 mt-3">I'm <span>Chandlee Rey Belarmino</span></h1>
    ...
    <section class="ftco-section ftco-no-pb" id="resume-section">
    	<div class="container">
          ...
          <div class="col-md-10 heading-section text-center ftco-animate">
            ...
            <p>Highly motivated and dedicated Computer Science student with a passion for programming and a strong foundation in the field.
				 Possessing a deep understanding of various programming languages and concepts, I am committed to continually expanding my
				 knowledge and honing my skills to become a proficient software developer. With a keen eye for detail and a problem-solving
				 mindset, I strive to deliver innovative solutions that meet both user requirements and industry standards. Seeking an opportunity
				 to contribute to a dynamic team where I can apply my technical expertise and collaborate with professionals to create cutting-edge software solutions.</p>
          </div>
        </div>
    		<div class="row">
    			<div class="col-md-6">
    		...
    		<div class="row">
					...
					<div class="col-md-4 text-center d-flex ftco-animate">
						<a href="#" class="services-1">
							...
							<div class="desc">
								<h3 class="mb-5">Arduino Projects</h3>
							</div>
						</a>
					</div>
					<div class="col-md-4 text-center d-flex ftco-animate">
        ...
        <div class="row d-flex contact-info mb-5">
          ...
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="tel://09512373065">+63 951 2373 065</a></p>
	          </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="mailto:Chandleerey54@gmail.com">Chandleerey54@gmail.com</a></p>
	          </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center">
